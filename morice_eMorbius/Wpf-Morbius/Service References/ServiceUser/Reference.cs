...
namespace Wpf_Morbius.ServiceUser {
    ...
    public interface IServiceUser {
        ...
        Wpf_Morbius.ServiceUser.User[] GetListUser();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetListUser", ReplyAction="http://tempuri.org/IServiceUser/GetListUserResponse")]
        System.Threading.Tasks.Task<Wpf_Morbius.ServiceUser.User[]> GetListUserAsync();
        ...
        Wpf_Morbius.ServiceUser.User GetUser(string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/GetUser", ReplyAction="http://tempuri.org/IServiceUser/GetUserResponse")]
        System.Threading.Tasks.Task<Wpf_Morbius.ServiceUser.User> GetUserAsync(string login);
        ...
        bool AddUser(Wpf_Morbius.ServiceUser.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceUser/AddUser", ReplyAction="http://tempuri.org/IServiceUser/AddUserResponse")]
        System.Threading.Tasks.Task<bool> AddUserAsync(Wpf_Morbius.ServiceUser.User user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceUserChannel : Wpf_Morbius.ServiceUser.IServiceUser, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceUserClient : System.ServiceModel.ClientBase<Wpf_Morbius.ServiceUser.IServiceUser>, Wpf_Morbius.ServiceUser.IServiceUser {
        ...
        public Wpf_Morbius.ServiceUser.User[] GetListUser() {
            return base.Channel.GetListUser();
        }
        
        public System.Threading.Tasks.Task<Wpf_Morbius.ServiceUser.User[]> GetListUserAsync() {
            return base.Channel.GetListUserAsync();
        }
        
        public Wpf_Morbius.ServiceUser.User GetUser(string login) {
            return base.Channel.GetUser(login);
        }
        
        public System.Threading.Tasks.Task<Wpf_Morbius.ServiceUser.User> GetUserAsync(string login) {
            return base.Channel.GetUserAsync(login);
        }
        
        public bool AddUser(Wpf_Morbius.ServiceUser.User user) {
            return base.Channel.AddUser(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddUserAsync(Wpf_Morbius.ServiceUser.User user) {
