...
namespace Wpf_Morbius.ServicePatient {
    ...
    public partial class Patient : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Wpf_Morbius.ServicePatient.Observation[] ObservationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Wpf_Morbius.ServicePatient.Observation[] Observations {
            get {
    ...
    public interface IServicePatient {
        ...
        Wpf_Morbius.ServicePatient.Patient[] GetListPatient();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetListPatient", ReplyAction="http://tempuri.org/IServicePatient/GetListPatientResponse")]
        System.Threading.Tasks.Task<Wpf_Morbius.ServicePatient.Patient[]> GetListPatientAsync();
        ...
        Wpf_Morbius.ServicePatient.Patient GetPatient(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetPatient", ReplyAction="http://tempuri.org/IServicePatient/GetPatientResponse")]
        System.Threading.Tasks.Task<Wpf_Morbius.ServicePatient.Patient> GetPatientAsync(int id);
        ...
        bool AddPatient(Wpf_Morbius.ServicePatient.Patient user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/AddPatient", ReplyAction="http://tempuri.org/IServicePatient/AddPatientResponse")]
        System.Threading.Tasks.Task<bool> AddPatientAsync(Wpf_Morbius.ServicePatient.Patient user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePatientChannel : Wpf_Morbius.ServicePatient.IServicePatient, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePatientClient : System.ServiceModel.ClientBase<Wpf_Morbius.ServicePatient.IServicePatient>, Wpf_Morbius.ServicePatient.IServicePatient {
        ...
        public Wpf_Morbius.ServicePatient.Patient[] GetListPatient() {
            return base.Channel.GetListPatient();
        }
        
        public System.Threading.Tasks.Task<Wpf_Morbius.ServicePatient.Patient[]> GetListPatientAsync() {
            return base.Channel.GetListPatientAsync();
        }
        
        public Wpf_Morbius.ServicePatient.Patient GetPatient(int id) {
            return base.Channel.GetPatient(id);
        }
        
        public System.Threading.Tasks.Task<Wpf_Morbius.ServicePatient.Patient> GetPatientAsync(int id) {
            return base.Channel.GetPatientAsync(id);
        }
        
        public bool AddPatient(Wpf_Morbius.ServicePatient.Patient user) {
            return base.Channel.AddPatient(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddPatientAsync(Wpf_Morbius.ServicePatient.Patient user) {
